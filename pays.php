...
<div
    ...
    <div
        ...
        if (isset($_POST['add_plans_title'])) {
            ...
            $name_category_plans = $_POST['name_category_bobres'];
            $name_servers_plans = $_POST['name_servers_bobres'];
        ...
        <form method="post">
            ...
            <div class="mt-4 mb-6">
                ...
                <label class="block mt-4 text-sm mx-auto" style="width: 98%">
                    ...
                    <select name="name_category_bobres"
                ...
                <label class="block mt-4 text-sm mx-auto" style="width: 98%">
                    ...
                    <select name="name_servers_bobres"
                        class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-select focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray">
                        <?php
