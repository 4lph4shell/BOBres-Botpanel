...
<br>
            ...
            if (isset($_POST['btn_edit'])) {
                ...
                $stmt->bind_param('sssiiiiisiiisssi', $title_plans, $protocol_plans, $type_plans, $price_plans, $days_plans, $volume_plans, $limitip_plans, $inbound_id_plans, $description_plans, $name_category_bobres_plans, $name_server_bobres_plans, $acount_plans, $custom_path_planss, $custom_port_planss, $custom_sni_planss, $value['id']);
                $stmt->execute();
