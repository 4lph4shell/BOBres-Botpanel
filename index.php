...
<aside
    ...
    <div class="py-4 text-gray-500 dark:text-gray-400">
        ...
        <div class="ml-2 flex justify-start items-center ">
            ...
            <a class=" text-lg font-bold text-gray-800 dark:text-gray-200" href="index.php"> Bobres <span class="px-1 ml-1 rounded" style="font-size: 10px;background-color: #e7cef1;color:#45013c !important;"> v 1.7.4.7</span>
                    ...
                    <table class="w-full whitespace-no-wra">
                        ...
                        if (is_array($users_select) || is_object($users_select)) {
                            foreach (
                                ...
                                echo '<img class="object-cover w-full h-full rounded-full" src="icons/breaver.png" alt="" loading="lazy">';
