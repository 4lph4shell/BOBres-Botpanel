    ...
    <li class="relative px-6 py-3">
        <a
            ...
            <svg fill="gray" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1"
                ...
                xml:space="preserve" width="21" height="21">
                <g>
...
<div class="px-6 my-2 mt-4">
    <a href="https://t.me/ALPH4Co" target="_blank">
        <button
...
<div class="px-6 my-2">
    <a href="https://github.com/4lph4shell/bobres-bot" target="_blank">
        <button
...
<div class="px-6 my-2">
    <a href="https://4lph4.ir/" target="_blank">
        <button class="flex items-center shadow-xl justify-between w-full px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-gray-500 border border-transparent rounded-lg active:bg-gray-600 hover:bg-gray-700 focus:outline-none focus:shadow-outline-gray">
            ...
            <span class="ml-2" aria-hidden="true">
                <svg fill="#ffffff" width="25px" height="25px" viewBox="0 0 100 100" version="1.1" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
...
<div
    ...
    class="fixed inset-0 z-10 flex items-end bg-black bg-opacity-20 sm:items-center sm:justify-center"></div>
<aside
    ...
    <div class="py-4 text-gray-500 dark:text-gray-400">
        <div class="lottie-container0" id="lottie-animation"></div>
        <div class="ml-2 flex justify-start items-center ">
            <a class=" text-lg font-bold text-gray-800 dark:text-gray-200" href="index.php"> Bobres <span class="px-1 ml-1 rounded" style="font-size: 10px;background-color: #e7cef1;color:#45013c !important;"> v 1.7.4.7</span></a>
        </div>
        <ul class="mt-6">
            <li class="relative px-6 py-3">
                <a
            ...
            <li class="relative px-6 py-3">
                <a
                    ...
                    <svg fill="gray" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                        ...
                        style="enable-background:new 0 0 512 512;" xml:space="preserve" width="21" height="21">
                        <g>
                            <path d="M480,224H288V32c0-17.673-14.327-32-32-32s-32,14.327-32,32v192H32c-17.673,0-32,14.327-32,32s14.327,32,32,32h192v192   c0,17.673,14.327,32,32,32s32-14.327,32-32V288h192c17.673,0,32-14.327,32-32S497.673,224,480,224z" />
                        </g>
                    </svg>
    ...
    <main class="h-full pb-16 overflow-y-auto">
        <div class="container grid px-6 mx-auto ">
            ...
            <div style='margin-top:40px' class=" w-full flex justify-center items-center grid gap-6 mb-8 xl:grid-cols-4 lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-2 grid-cols-1">
                ...
                $sql_plans = "SELECT * FROM server_plans where bobi = 0 and inbound_id = 0 ORDER BY id DESC";
...
';
            ...
            ?>
                    ...
                    <label class="block mt-2 text-sm mx-auto" style="width: 99%">
                        <select required name="name_category_bobres"
                    ...
                    <label class="block mt-2 text-sm mx-auto" style="width: 99%">
                        <select required name="name_server_bobres"
                            class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-select focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray">
                            <?php
...
<br>
            ...
            if (isset($_POST['btn_edit'])) {
                ...
                $name_category_bobres_plans = $_POST["name_category_bobres"];
                $name_server_bobres_plans = $_POST["name_server_bobres"];
                ...
                $stmt->bind_param('sssiiiiisiiissssi', $title_plans, $protocol_plans, $type_plans, $price_plans, $days_plans, $volume_plans, $limitip_plans, $inbound_id_plans, $description_plans, $name_category_bobres_plans, $name_server_bobres_plans, $acount_plans, $dest_reality_plans, $serverNames_reality_plans, $spiderX_reality_plans, $flow_reality_plans, $value['id']);
                $stmt->execute();
    ...
    <div
        ...
        <form id="insert_plans1">
            <div style="height: 300px;overflow-y: scroll;">
                ...
                <label class="block mt-2 text-sm mx-auto" style="width: 98%">
                    <select required name="name_servers_bobres"
                        class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-select focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray">
                        <?php
...
<script>
    ...
    lottie.loadAnimation({
        container: document.getElementById('lottie-animation0'), // ID of the element
        renderer: 'svg',
        loop: true,
        autoplay: true,
        path: 'assets/lotti/00.json' // Path to the Lottie JSON file
    });
</script>
<script>
    // Initialize Lottie animation
